...
class Options {
 public:
  ...
  static const std::string& getdiameterconfiguration() {
    return m_diameterconfiguration;
  }
  ...
  static const unsigned& getcasscoreconnections() {
    return m_casscoreconnections;
  }
  static const unsigned& getcassmaxconnections() {
    return m_cassmaxconnections;
  }
